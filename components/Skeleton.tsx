      ...
      {[0, 1].map((g) => (
        <div key={g}>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            {[0, 1, 2].map((i) => (
              <div key={i} className={`flex items-center gap-3 px-4 py-3 ${i !== 2 ? 'border-b border-gray-50' : ''}`}>
...
export function StatsContentSkeleton() {
  return (
    <div className="space-y-4">
      {[0, 1].map((card) => (
        <div key={card} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
  ...
  return (
    <div className="space-y-2">
      {Array.from({ length: rows }, (_, i) => (
        <div key={i} className="flex items-center gap-3 p-3.5 bg-white rounded-2xl shadow-sm border border-gray-100">
